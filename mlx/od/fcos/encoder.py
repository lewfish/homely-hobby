...
def encode_box(arr, stride, box):
    # arr is (4, h, w) where first dimension ranges over t, l, b, r
    ...
    h, w = torch.Tensor(list(arr.shape[1:])) * stride
    ...
    arr[:, nw_ij[0]:se_ij[0]+1, nw_ij[1]:se_ij[1]+1] = box_arr